...
-(void)shootPhaser
{
    ...
    else
    {
        ...
        xPosition -= (boundingBox.size.width * 0.542f); // Reverse by changing positive sign to negative
        phaserDir = kDirectionLeft;
    }
    phaserFiringPosition = ccp(xPosition, yPosition);
    [delegate createPhaserWithDirection:phaserDir
                            andPosition:phaserFiringPosition];
}
           ...
           andListOfGameObjects:(CCArray*)listOfGameObjects
{
    ...
    CGRectIntersectsRect(vikingBoundingBox, robotBoundingBox) ?
    YES : NO;
    isVikingWithinSight =
    CGRectIntersectsRect(vikingBoundingBox, robotSightBoundingBox)?
    YES : NO;
